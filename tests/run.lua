...
assert_eq(#Source.list(), 5, "source list")
...
assert_eq(#shown_menu.items, 4, "Truyện lists four sources")
assert_eq(shown_menu.items[4].text, "Truyện Full", "TruyenFull discoverable")
