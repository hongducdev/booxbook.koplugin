...
UI.openSource(); shown.on_search(); prompt.on_submit(' https://truyenfull.live/linh-vu-thien-ha/ ')
assert(selected == 'https://truyenfull.live/linh-vu-thien-ha/')
prompt.on_submit('  '); assert(selected == 'https://truyenfull.live/linh-vu-thien-ha/')
prompt.on_submit('/linh-vu-thien-ha/'); assert(selected == '/linh-vu-thien-ha/')
