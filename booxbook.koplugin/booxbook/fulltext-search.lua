...
-- The diacritic map is defined once in booxbook.library (it has no dependencies) so the
-- plugin ships a single 2 KB copy instead of two identical tables.
local Library = require("booxbook.library")
local accents = Library.accents
